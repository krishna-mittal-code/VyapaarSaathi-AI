        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-blue-500">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">Smart Merchant Dashboard</h3>
              <p className="text-gray-600">Real-time sales tracking, transaction analytics, and performance metrics at your fingertips.</p>
            </div>
            
            <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-green-500">
              <div className="text-3xl mb-3">🤖</div>
              <h3 className="text-xl font-bold text-gray-800 mb-2">AI-Powered Insights</h3>
              <p className="text-gray-600">Discover hidden patterns, customer behavior trends, and actionable business intelligence.</p>
            </div>
            
            <div className="bg-white rounded-xl shadow-lg p-6 border-l-4 border-purple-500">
              <div className="text-3xl mb-3">🚀</div>
              <h3 className="text-xl font-bold text-gray-800 mb-2">Growth Recommendations</h3>
              <p className="text-gray-600">Personalized strategies to boost sales, improve customer retention, and scale your business.</p>
            </div>
          </div>
        </div>
      </div>
